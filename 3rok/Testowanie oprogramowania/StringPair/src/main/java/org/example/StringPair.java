...
public class StringPair {
     ...
     * @param right
     */
    public void setRight(String right) {      //brak sprawdzenia warunkow brzegowych
        hashCode = -1;
        this.right = right;
    }
     ...
     * @param left
     */
    public void setLeft(String left) {           //brak sprawdzenia warunkow brzegowych
        hashCode = -1;
        this.left = left;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof StringPair) {
            ...
            if (other.hashCode() == hashCode()) {     //porownujemy hashcode przed stringpair
