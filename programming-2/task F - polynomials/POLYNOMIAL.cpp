...
{                         // funkcja przesuwa wielomian poprzez usuniecie zerowych wspolczynnikow na koncu tablicy
...
POLYNOMIAL POLYNOMIAL::operator/(const POLYNOMIAL &a)
{
    if ((a.degree == 0 && a.pol[0] == 0) || (this->degree < a.degree))
        return POLYNOMIAL();
    if (*this == a)
        return POLYNOMIAL(0, 1);
    if (a.degree == 0 && a.pol[0] == -1)
        return *this * a;
    if (a.degree == 0 && a.pol[0] == -1)
        return *this;
...
POLYNOMIAL POLYNOMIAL::operator%(const POLYNOMIAL &a)
{
    ...
    if ((*this == a) || (a.degree == 0 && a.pol[0] == 0) || (this->degree < a.degree))
        return POLYNOMIAL();
    if (*this == a)
        return POLYNOMIAL(0, 1);
